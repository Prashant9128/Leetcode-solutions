...
<p align="center">
  <img src="https://raw.githubusercontent.com/rahuldkjain/github-profile-readme-generator/master/src/images/icons/Social/leet-code.svg" alt="LeetCode" width="80" height="80" />
</p>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Syncing_Via-LeetSync-blue?style=for-the-badge&logo=google-chrome&logoColor=white" alt="LeetSync Badge" />
</p>
...
sequenceDiagram
    autonumber
    actor Me as Me (Solving Problem)
    participant LC as LeetCode
    participant LS as LeetSync Extension
    participant GH as GitHub Repository

    Me->>LC: Submit Code
    LC-->>Me: Status: Accepted
    LS->>LC: Detect Accepted Submission
    LS->>GH: Commit & Push Code Automatically
    GH-->>Me: Update Repo Structure
```
